...
// AuthSessionMiddleware is auth sessions middleware using redis
...
// AuthJWTMiddleware is JWT way of auth using cookie or Authorization header
...
// OwnerOrAdminMiddleware is Role based auth middleware, using ctx user
...
// RoleBasedAuthMiddleware is based auth middleware, using ctx user
...
// CheckAuth checks	 auth middleware
